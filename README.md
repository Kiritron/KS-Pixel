...
##### Использование
У данной библиотеки есть вики по [этой ссылке](https://bitbucket.org/kiritron/ks-piksel/wiki/Home) и JavaDoc по [этой](https://kiritron.space/javadoc/pixel/), в которых я пусть и лениво, но написал, как использовать функции библиотеки.
